...
export const Rating = forwardRef(({ error, isEditable = false, rating, setRating, className, tabIndex, ...props }: RatingProps, ref: ForwardedRef<HTMLDivElement>): JSX.Element => {
